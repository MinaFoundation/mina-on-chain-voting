...
async fn get_mina_proposal(ctx: Extension<crate::Context>, Path(id): Path<i32>) -> Result<impl IntoResponse> {
  use crate::schema::mina_proposals::dsl as mina_proposal_dsl;
...
async fn get_mina_proposal_result(ctx: Extension<crate::Context>, Path(id): Path<i32>) -> Result<impl IntoResponse> {
  use crate::schema::mina_proposals::dsl as mina_proposal_dsl;
